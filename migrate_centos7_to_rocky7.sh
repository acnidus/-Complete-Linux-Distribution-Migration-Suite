...
# =============================================================================
# CentOS Linux 7 to Rocky Linux 7 Migration Script
# =============================================================================
# 
# This script migrates a system from CentOS Linux 7.x to Rocky Linux 7.x
# 
# IMPORTANT: 
...
# - CentOS 7 reached EOL in June 2024, migration is highly recommended
#
...
LOG_FILE="/var/log/centos7_to_rocky7_migration.log"
BACKUP_DIR="/backup/pre_migration"
ROLLBACK_FILE="/etc/yum.repos.d/centos7_rollback.repo"
...
check_system_requirements() {
    ...
    # Check if this is actually CentOS 7
    if ! grep -q "CentOS Linux release 7" /etc/redhat-release 2>/dev/null; then
        error "This system is not running CentOS Linux 7"
    ...
    if [[ "$centos_version" != "7" ]]; then
        error "This script is designed for CentOS 7, but system shows version $centos_version"
        exit 1
    fi
...
# Rollback repository for CentOS 7
# This file contains the original CentOS 7 repository configuration
# Use this to rollback if migration fails
# Note: CentOS 7 repositories are available in vault.centos.org
...
prepare_system() {
    ...
    yum remove -y centos-release centos-logos || warning "Could not remove CentOS release packages"
...
display_post_migration_instructions() {
    ...
    echo "============================================================================="
    echo
    echo "Your system has been migrated from CentOS Linux 7 to Rocky Linux 7."
    echo
...
main() {
    echo "============================================================================="
    echo "CentOS Linux 7 to Rocky Linux 7 Migration Script"
    echo "============================================================================="
    echo
